...
public class VersionChecker {
    private static final String RELEASE_API_URL = "https://api.github.com/repos/maxwai/NClientV2-ng/releases";
    private static final String LATEST_RELEASE_URL = "https://github.com/maxwai/NClientV2-ng/releases/latest";
