package com.maxwai.nclientv2NG.components.views;
...
import com.maxwai.nclientv2NG.CopyToClipboardActivity;
import com.maxwai.nclientv2NG.PINActivity;
import com.maxwai.nclientv2NG.R;
import com.maxwai.nclientv2NG.SettingsActivity;
import com.maxwai.nclientv2NG.StatusManagerActivity;
import com.maxwai.nclientv2NG.async.MetadataFetcher;
import com.maxwai.nclientv2NG.async.VersionChecker;
import com.maxwai.nclientv2NG.components.LocaleManager;
import com.maxwai.nclientv2NG.components.launcher.LauncherCalculator;
import com.maxwai.nclientv2NG.components.launcher.LauncherReal;
...
public class GeneralPreferenceFragment extends PreferenceFragmentCompat {
    ...
    private void mainMenu() {
        ...
        findPreference("bug").setOnPreferenceClickListener(preference -> {
            Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/maxwai/NClientV2-ng/issues/new"));
            startActivity(i);
            return true;
        });
        // TODO: remove donate
        findPreference("donate").setOnPreferenceClickListener(preference -> {
            Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/maxwai/NClientV2-ng#donation"));
            startActivity(i);
            return true;
        });
