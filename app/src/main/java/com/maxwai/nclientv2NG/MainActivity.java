...
import com.maxwai.nclientv2NG.adapters.ListAdapter;
...
import com.maxwai.nclientv2NG.api.components.Ranges;
import com.maxwai.nclientv2NG.api.components.Tag;
import com.maxwai.nclientv2NG.api.enums.ApiRequestType;
import com.maxwai.nclientv2NG.api.enums.Language;
import com.maxwai.nclientv2NG.api.enums.SortType;
...
import com.maxwai.nclientv2NG.async.ScrapeTags;
import com.maxwai.nclientv2NG.async.VersionChecker;
import com.maxwai.nclientv2NG.async.database.Queries;
import com.maxwai.nclientv2NG.async.downloader.DownloadGalleryV2;
import com.maxwai.nclientv2NG.components.CookieInterceptor;
import com.maxwai.nclientv2NG.components.GlideX;
import com.maxwai.nclientv2NG.components.activities.BaseActivity;
import com.maxwai.nclientv2NG.components.views.PageSwitcher;
import com.maxwai.nclientv2NG.components.widgets.CustomGridLayoutManager;
import com.maxwai.nclientv2NG.settings.Global;
import com.maxwai.nclientv2NG.settings.Login;
import com.maxwai.nclientv2NG.settings.TagV2;
import com.maxwai.nclientv2NG.utility.ImageDownloadUtility;
...
public class MainActivity extends BaseActivity
    ...
    private void initializeNavigationView() {
        ...
        onlineFavoriteManager.setVisible(com.maxwai.nclientv2NG.settings.Login.isLogged());
    }
    ...
    private void loadStringLogin() {
        ...
        if (com.maxwai.nclientv2NG.settings.Login.getUser() != null)
            loginItem.setTitle(getString(R.string.login_formatted, com.maxwai.nclientv2NG.settings.Login.getUser().getUsername()));
        else
            loginItem.setTitle(com.maxwai.nclientv2NG.settings.Login.isLogged() ? R.string.logout : R.string.login);
    ...
    private void useDataSearchMode(Uri data, List<String> datas) {
        ...
        if (favorite) {
            if (com.maxwai.nclientv2NG.settings.Login.isLogged()) useFavoriteMode(page);
            else {
    ...
    protected void onResume() {
        ...
        com.maxwai.nclientv2NG.settings.Login.initLogin(this);
