...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mCollapsingTextHelper.setMaxLines(typedArray.getInteger(R.styleable.CollapsingToolbarLayoutExtension_maxLines, 3));
        mCollapsingTextHelper.setLineSpacingExtra(typedArray.getFloat(R.styleable.CollapsingToolbarLayoutExtension_lineSpacingExtra, 0));
        mCollapsingTextHelper.setLineSpacingMultiplier(typedArray.getFloat(R.styleable.CollapsingToolbarLayoutExtension_lineSpacingMultiplier, 1));
        typedArray.recycle();
        // END MODIFICATION
    }
